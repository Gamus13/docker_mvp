...
const URLInput = () => {
  ...
  return (
    <div className="w-full max-w-md mx-auto relative">
      <label className="text-sm font-medium mb-2 block">Paste a URL :</label>
      <div className="relative flex flex-col items-start">
        <input
          ...
          onChange={(e) => setUrl(e.target.value)}
          placeholder="http://example.com"
          className="p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 w-full" // Pas besoin de padding pour le message maintenant
        />
