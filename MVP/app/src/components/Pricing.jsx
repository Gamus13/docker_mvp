...
//         try {
//             const response = await axios.get('/stripe/checkout', {
//                 method: 'POST',
//                 headers: {
...
//                             //     <Link to="/payement" className="mt-6 px-10 text-white py-2 border border-secondary hover:bg-secondary hover:text-white bg-sky-500 font-semibold rounded-lg">
//                             //         Get Started
//                             //     </Link>
//                             // </div>
//                             <div className="w-full mx-auto flex items-center justify-center mt-5">
...
//                                 <button
//                                 onClick={() =>
//                                     handlePayment(pkg.name, isYearly ? pkg.yearlyPrice : pkg.monthlyPrice)
//                                 }
//                                 className="mt-6 px-10 text-white py-2 border border-secondary hover:bg-secondary hover:text-white bg-sky-500 font-semibold rounded-lg"
//                                 >
//                                 Get Started
