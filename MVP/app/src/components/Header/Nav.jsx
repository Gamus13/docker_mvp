...
const Header = () => {
  ...
  return (
    <>
      ...
      <header className={`navbar left-0 top-0 z-40 flex w-full items-center ${theme === 'dark' ? 'bg-gray-900 text-white text-base' : 'bg-light-900 text-base'} ${sticky ? "dark:bg-gray-dark dark:shadow-sticky-dark fixed z-[9999] bg-gray-400 !bg-opacity-80 shadow-sticky backdrop-blur-sm transition" : "absolute bg-transparent"}`}>
